...
counties_census_ccd <- left_join(counties2013f, CCD2009_13_merge, 
                                 c("GEOID" = "county09"))

## Join Census/CCD df to Census sf
counties_cenccd_sf <- left_join(counties_census_ccd, counties_sf,
                                by = join_by(GEOID, NAME))
```
